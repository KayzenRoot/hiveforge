...
All notable changes to HiveForge are documented here.

## [Unreleased]

- Reconcile the authoritative Master Source V0.1.4 when it is supplied.

## [0.1.0-alpha.2]

- Close the real Codex turn-to-validation-to-review loop with durable SQLite turn state.
- Align the adapter with codex-cli 0.152.0 App Server stdio, account/read and turn/completed.
...
- Add CI, contribution guidance, security reporting, issue forms, and release governance.
- Add a Windows-first execution finalizer for repeatable validation and publication.
