...
type Project = { id: string; name: string; localPath: string; autonomyMode: string; workingBranch: string; reviewMailboxPath: string; latestRun?: { id: string; state: string; iterationCount: number; updatedAt: string } };
...
export default function Dashboard() {
  ...
  const latestRun = selected?.latestRun;
